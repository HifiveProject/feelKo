...
public interface WishListRepository extends JpaRepository<WishList, Long> {
    ...
    @Query("SELECT new com.ll.feelko.domain.wishlist.dto.WishListPageDto(w.experience.id, w.experience.title, w.experience.price, w.experience.startDate, w.experience.endDate) FROM WishList w WHERE w.member.id = :memberId AND w.experience.experienceClose = false ORDER BY w.id DESC")
